...
custom_sessions, STORES, AND STATELESS MODE
====================================
...
class Consumer(object):
    ...
    def setAssociationPreference(self, association_preferences):
        """Set the order in which association types/custom_sessions should be
...
class GenericConsumer(object):
    ...
    def _verifyDiscoveryResultsOpenID2(self, resp_msg, endpoint):
        ...
        # again. This covers not using custom_sessions, OP identifier
