...
from .views import ConvertTokenView, TokenView, RevokeTokenView, invalidate_custom_sessions, DisconnectBackendView
...
urlpatterns = [
    ...
    url(r'^invalidate-custom_sessions/?$', invalidate_custom_sessions, name="invalidate_custom_sessions"),
