...
if app_settings.USERcustom_sessions_ENABLED and not app_settings.HEADLESS_ONLY:
    urlpatterns += [path("custom_sessions/", include("allauth.usercustom_sessions.urls"))]
