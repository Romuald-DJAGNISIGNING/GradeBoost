    ...
    post:
      ...
      responses:
        ...
        "401":
          $ref: "#/components/responses/Authentication"
  ######################################################################
  # Authentication: Current custom_sessions
  ######################################################################
  /_allauth/{client}/v1/auth/custom_sessions:
    get:
      tags:
        - "custom_sessions"
      summary: List custom_sessions
      parameters:
        - $ref: "#/components/parameters/Client"
        - $ref: "#/components/parameters/SessionToken"
      responses:
        "200":
          $ref: "#/components/responses/custom_sessions"
    delete:
      tags:
        - "custom_sessions"
      summary: End one or more custom_sessions
      parameters:
        - $ref: "#/components/parameters/Client"
        - $ref: "#/components/parameters/SessionToken"
      requestBody:
        $ref: "#/components/requestBodies/Endcustom_sessions"
      responses:
        "200":
          $ref: "#/components/responses/custom_sessions"
        "401":
  ...
  requestBodies:
    ...
    Endcustom_sessions:
      ...
      content:
        application/json:
          schema:
            $ref: "#/components/schemas/Endcustom_sessions"
    PasskeySignup:
  ...
  schemas:
    ...
    Endcustom_sessions:
      ...
      properties:
        custom_sessions:
          description: |
            The IDs of the custom_sessions that are to be ended.
          type: array
          items:
            type: integer
            example: 123
    ...
    MFAConfiguration:
      ...
      required:
        - supported_types
    Usercustom_sessionsConfiguration:
      type: object
      description: |
        Configuration of the Django `allauth.usercustom_sessions` app.
      properties:
        track_activity:
          type: boolean
          description: |
            Matches `settings.USERcustom_sessions_TRACK_ACTIVITY`.
      required:
        - track_activity
      ...
      properties:
        data:
          ...
          properties:
            ...
            usercustom_sessions:
              $ref: "#/components/schemas/Usercustom_sessionsConfiguration"
          required:
            - account
        status:
          $ref: "#/components/schemas/StatusOK"
