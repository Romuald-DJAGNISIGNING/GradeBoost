...
class ConfigResponse(APIResponse):
    def __init__(self, request):
        ...
        if allauth_settings.USERcustom_sessions_ENABLED:
            from allauth.headless.usercustom_sessions.response import (
                get_config_data as get_usercustom_sessions_config_data,
            )

            data.update(get_usercustom_sessions_config_data(request))
