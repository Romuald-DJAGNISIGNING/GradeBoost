            ...
            <div>
                ...
                <ul>
                    {% if user.is_authenticated %}
                        ...
                        {% endif %}
                        {% url 'usercustom_sessions_list' as usercustom_sessions_list_url_ %}
                        {% if usercustom_sessions_list_url_ %}
                            <li>
                                <a href="{{ usercustom_sessions_list_url_ }}">{% trans "custom_sessions" %}</a>
                            </li>
                        {% endif %}
